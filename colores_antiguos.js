...
//document.getElementById("PL").style.color='#FFFFFF';// color de palabra: participants.//
//document.getElementById("PC").style.color='#FFFFFF';// color del numero de usuarios en la sala

//document.getElementById("RN").style.color='#FFFFFF';//color del nombre de la sala.
